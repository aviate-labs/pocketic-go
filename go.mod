module github.com/aviate-labs/pocketic-go

go 1.23.4

require github.com/aviate-labs/agent-go v0.6.0

require (
	github.com/aviate-labs/ic-go v0.0.0-20241228134019-7093ee37f5d4 // indirect
